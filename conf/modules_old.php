...
define('CYT_PATH', APP_PATH . '/classes/com/centros/');
define('CYT_PATH_TEST', APP_PATH . '/unit_test/');


/* mvc */
define('MVC_CYT_PATH', $_SERVER ['DOCUMENT_ROOT'] . '/cyt_mvc/');
define('CYT_SECURE_PATH', MVC_CYT_PATH .   'cyt_secure_director/');
...
define('CDT_MVC_APP_SUBTITLE', 'Centros, laboratorios e institutos');
...
define("CDT_SECURE_USERGROUP_DEFAULT_ID", 2);
